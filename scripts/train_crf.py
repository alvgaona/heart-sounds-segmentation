#!/usr/bin/env python3
"""Train heart sound segmentation model with CRF layer."""
...
def main() -> None:
    ...
    model = LitModelCRF(input_size=44, batch_size=batch_size, device=device)
    ...
    trainer = pl.Trainer(
        ...
        default_root_dir="lightning_logs_crf",
    )
