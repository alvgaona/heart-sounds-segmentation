...
patológica y no patológicas, mediante una \gls{rnn} (\textit{Recurrent Neural Network}). Particularmente esta
red neuronal se denomina \textit{Long Short Term Memory} (\gls{lstm}). Esta aplicación basada en una red LSTM
...
relativamente amorfas a otras señales conocidas. Entre estas se encuentra, el electrocariograma (\gls{ecg}),
...
\gls{ecg} extrayendo de esto la onda R y el fin de la onda T. La implementación se encuentra basada en
