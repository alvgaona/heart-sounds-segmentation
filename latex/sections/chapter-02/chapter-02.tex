...
\section{Actividad eléctrica del corazón} \label{section:electrical-activity}
...
\subsection{El potencial de acción cardíaco} \label{subsection:action-potential}
...
\subsection{Ruidos cardíacos} \label{subsection:cardiac-sounds}
...
auscultación o fonocardiografía.
    ...
    \begin{table}[H] 
        ...
        \begin{tabular}{ |llll| }
         ...
         \thead{1$^{er}$ ruido} & \ thead{Inicio de la \\ sístole ventricular} & \thead{Cierre de válvulas AV} &
